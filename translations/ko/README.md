...
다음 단계를 따라 이러한 리소스를 사용하기 시작하세요:
1. **저장소 포크**: 클릭 [![GitHub forks](https://img.shields.io/github/forks/microsoft/mcp-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/mcp-for-beginners/fork)
2. **저장소 클론**:   `git clone https://github.com/microsoft/mcp-for-beginners.git`
3. **다음에 참여하세요** [![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)
...
> **로컬로 클론하기를 선호하시나요?**
>
> 이 저장소에는 50개 이상의 번역본이 포함되어 있어 다운로드 크기가 크게 증가합니다. 번역 없이 클론하려면 sparse checkout을 사용하세요:
>
> **Bash / macOS / Linux:**
> ```bash
...
## **C#, Java, JavaScript, Rust, Python, TypeScript로 배우는 MCP 실전 코드 예제**
...
- 📘 [MCP 문서](https://modelcontextprotocol.io/) – 단계별 튜토리얼과 사용자 가이드가 포함된 기본 리소스입니다. 초보자를 위해 작성되어, 자신의 속도에 맞춰 따라할 수 있는 명확한 예제를 제공합니다.
- 📜 [MCP 사양서](https://modelcontextprotocol.io/specification/2025-11-25) – 종합 참고 매뉴얼로 생각하세요. 커리큘럼 진행 중 특정 세부사항을 확인하거나 고급 기능을 탐색할 때 여기로 돌아오게 될 것입니다.
- 📜 [MCP 사양 버전 관리](https://modelcontextprotocol.io/specification/versioning) – 프로토콜 버전 이력과 MCP가 날짜 기반 버전 관리(YYYY-MM-DD 형식)를 사용하는 방법에 대한 정보가 포함되어 있습니다.
- 🧑‍💻 [MCP GitHub 저장소](https://github.com/modelcontextprotocol) – SDK, 도구, 다중 프로그래밍 언어 샘플 코드가 모여 있습니다. 실용적인 예제와 바로 사용할 수 있는 컴포넌트의 보물창고와 같습니다.
- 🌐 [MCP 커뮤니티](https://github.com/orgs/modelcontextprotocol/discussions) – MCP에 대해 배우는 동료들과 경험 많은 개발자들이 모여 토론하는 곳입니다. 질문이 환영받고 지식이 자유롭게 공유되는 지원 커뮤니티입니다.
...
| 00 | MCP 소개 | 모델 컨텍스트 프로토콜과 AI 파이프라인에서의 중요성 개요 | [Read more](./00-Introduction/README.md) |
| 01 | 핵심 개념 설명 | MCP 핵심 개념 심층 탐구 | [Read more](./01-CoreConcepts/README.md) |
| 02 | MCP의 보안 | 보안 위협 및 모범 사례 | [Read more](./02-Security/README.md) |
| 03 | MCP 시작하기 | 환경 설정, 기본 서버/클라이언트, 통합 | [Read more](./03-GettingStarted/README.md) |
| **Module 3: 첫 서버 및 클라이언트 구축** | | | |
| 3.1 | 첫 서버 | 첫 MCP 서버 생성 | [Guide](./03-GettingStarted/01-first-server/README.md) |
| 3.2 | 첫 클라이언트 | 기본 MCP 클라이언트 개발 | [Guide](./03-GettingStarted/02-client/README.md) |
| 3.3 | LLM 클라이언트 | 대형 언어 모델 통합 | [Guide](./03-GettingStarted/03-llm-client/README.md) |
| 3.4 | VS Code 통합 | VS Code에서 MCP 서버 사용 | [Guide](./03-GettingStarted/04-vscode/README.md) |
| 3.5 | stdio 서버 | stdio 전송 방식으로 서버 생성 | [Guide](./03-GettingStarted/05-stdio-server/README.md) |
| 3.6 | HTTP 스트리밍 | MCP에서 HTTP 스트리밍 구현 | [Guide](./03-GettingStarted/06-http-streaming/README.md) |
| 3.7 | AI 툴킷 | MCP와 AI 툴킷 사용 | [Guide](./03-GettingStarted/07-aitk/README.md) |
| 3.8 | 테스팅 | MCP 서버 구현 테스트 | [Guide](./03-GettingStarted/08-testing/README.md) |
| 3.9 | 배포 | MCP 서버를 프로덕션에 배포 | [Guide](./03-GettingStarted/09-deployment/README.md) |
| 3.10 | 고급 서버 사용법 | 고급 기능 사용 및 향상된 아키텍처를 위한 서버 활용 | [Guide](./03-GettingStarted/10-advanced/README.md) |
| 3.11 | 간단한 인증 | 초보자용 인증 및 RBAC 설명 | [Guide](./03-GettingStarted/11-simple-auth/README.md) |
| 3.12 | MCP 호스트 | Claude Desktop, Cursor, Cline, 기타 MCP 호스트 설정 | [Guide](./03-GettingStarted/12-mcp-hosts/README.md) |
| 3.13 | MCP 인스펙터 | Inspector 도구로 MCP 서버 디버그 및 테스트 | [Guide](./03-GettingStarted/13-mcp-inspector/README.md) |
| 3.14 | 샘플링 | 클라이언트와 협업을 위한 샘플링 사용 | [Guide](./03-GettingStarted/14-sampling/README.md) |
| 3.15 | MCP 앱 | MCP 앱 구축 | [Guide](./03-GettingStarted/15-mcp-apps/README.md) |
| **Module 4-5: 실용적 & 고급** | | | |
| 04 | 실용적 구현 | SDK, 디버깅, 테스트, 재사용 가능한 프롬프트 템플릿 | [Read more](./04-PracticalImplementation/README.md) |
| 4.1 | 페이징 | 커서 기반 페이징으로 대용량 결과 처리 | [Guide](./04-PracticalImplementation/pagination/README.md) |
| 05 | MCP의 고급 주제 | 멀티모달 AI, 확장, 엔터프라이즈 활용 | [Read more](./05-AdvancedTopics/README.md) |
| 5.1 | Azure 통합 | Azure와 MCP 통합 | [Guide](./05-AdvancedTopics/mcp-integration/README.md) |
| 5.2 | 멀티모달리티 | 다양한 모달리티 작업 | [Guide](./05-AdvancedTopics/mcp-multi-modality/README.md) |
| 5.3 | OAuth2 데모 | OAuth2 인증 구현 | [Guide](./05-AdvancedTopics/mcp-oauth2-demo/README.md) |
| 5.4 | 루트 컨텍스트 | 루트 컨텍스트 이해 및 구현 | [Guide](./05-AdvancedTopics/mcp-root-contexts/README.md) |
| 5.5 | 라우팅 | MCP 라우팅 전략 | [Guide](./05-AdvancedTopics/mcp-routing/README.md) |
| 5.6 | 샘플링 | MCP 샘플링 기법 | [Guide](./05-AdvancedTopics/mcp-sampling/README.md) |
| 5.7 | 확장 | MCP 구현체의 확장 | [Guide](./05-AdvancedTopics/mcp-scaling/README.md) |
| 5.8 | 보안 | 고급 보안 고려사항 | [Guide](./05-AdvancedTopics/mcp-security/README.md) |
| 5.9 | 웹 검색 | 웹 검색 기능 구현 | [Guide](./05-AdvancedTopics/web-search-mcp/README.md) |
| 5.10 | 실시간 스트리밍 | 실시간 스트리밍 기능 구축 | [Guide](./05-AdvancedTopics/mcp-realtimestreaming/README.md) |
| 5.11 | 실시간 검색 | 실시간 검색 구현 | [Guide](./05-AdvancedTopics/mcp-realtimesearch/README.md) |
| 5.12 | Entra ID 인증 | Microsoft Entra ID 인증 | [Guide](./05-AdvancedTopics/mcp-security-entra/README.md) |
| 5.13 | Foundry 통합 | Azure AI Foundry와 통합 | [Guide](./05-AdvancedTopics/mcp-foundry-agent-integration/README.md) |
| 5.14 | 컨텍스트 엔지니어링 | 효과적인 컨텍스트 엔지니어링 기법 | [Guide](./05-AdvancedTopics/mcp-contextengineering/README.md) |
| 5.15 | MCP 맞춤형 전송 | 맞춤형 전송 구현 | [Guide](./05-AdvancedTopics/mcp-transport/README.md) |
| 5.16 | 프로토콜 기능 | 진행 알림, 취소, 리소스 템플릿 | [Guide](./05-AdvancedTopics/mcp-protocol-features/README.md) |
| **Module 6-10: 커뮤니티 & 모범 사례** | | | |
| 06 | 커뮤니티 기여 | MCP 생태계에 기여하는 방법 | [Guide](./06-CommunityContributions/README.md) |
| 07 | 초기 도입 인사이트 | 현실 구현 사례 | [Guide](./07-LessonsfromEarlyAdoption/README.md) |
| 08 | MCP 모범 사례 | 성능, 내결함성, 복원력 | [Guide](./08-BestPractices/README.md) |
| 09 | MCP 사례 연구 | 실용적 구현 예시 | [Guide](./09-CaseStudy/README.md) |
| 10 | 실습 워크샵 | AI 툴킷과 MCP 서버 구축 | [Lab](./10-StreamliningAIWorkflowsBuildingAnMCPServerWithAIToolkit/README.md) |
| **Module 11: MCP 서버 실습 랩** | | | |
| 11 | MCP 서버 데이터베이스 통합 | PostgreSQL 통합을 위한 13랩 실습 학습 경로 | [Labs](./11-MCPServerHandsOnLabs/README.md) |
| 11.1 | 소개 | 데이터베이스 통합과 소매 분석 유스케이스 개요 | [Lab 00](./11-MCPServerHandsOnLabs/00-Introduction/README.md) |
| 11.2 | 핵심 아키텍처 | MCP 서버 아키텍처, 데이터베이스 계층, 보안 패턴 이해 | [Lab 01](./11-MCPServerHandsOnLabs/01-Architecture/README.md) |
| 11.3 | 보안 및 멀티 테넌시 | 행 수준 보안, 인증, 다중 테넌트 데이터 접근 | [Lab 02](./11-MCPServerHandsOnLabs/02-Security/README.md) |
| 11.4 | 환경 설정 | 개발 환경, Docker, Azure 리소스 설정 | [Lab 03](./11-MCPServerHandsOnLabs/03-Setup/README.md) |
| 11.5 | 데이터베이스 설계 | PostgreSQL 설정, 소매 스키마 설계, 샘플 데이터 | [Lab 04](./11-MCPServerHandsOnLabs/04-Database/README.md) |
| 11.6 | MCP 서버 구현 | FastMCP 서버 구축 및 데이터베이스 통합 | [Lab 05](./11-MCPServerHandsOnLabs/05-MCP-Server/README.md) |
| 11.7 | 도구 개발 | 데이터베이스 쿼리 도구 및 스키마 인트로스펙션 제작 | [Lab 06](./11-MCPServerHandsOnLabs/06-Tools/README.md) |
| 11.8 | 의미 검색 | Azure OpenAI와 pgvector로 벡터 임베딩 구현 | [Lab 07](./11-MCPServerHandsOnLabs/07-Semantic-Search/README.md) |
| 11.9 | 테스트 및 디버깅 | 테스트 전략, 디버깅 도구, 검증 방법 | [Lab 08](./11-MCPServerHandsOnLabs/08-Testing/README.md) |
| 11.10 | VS Code 통합 | VS Code MCP 통합 및 AI 채팅 사용 설정 | [Lab 09](./11-MCPServerHandsOnLabs/09-VS-Code/README.md) |
| 11.11 | 배포 전략 | Docker 배포, Azure 컨테이너 앱, 확장 고려사항 | [Lab 10](./11-MCPServerHandsOnLabs/10-Deployment/README.md) |
| 11.12 | 모니터링 | 애플리케이션 인사이트, 로깅, 성능 모니터링 | [Lab 11](./11-MCPServerHandsOnLabs/11-Monitoring/README.md) |
| 11.13 | 모범 사례 | 성능 최적화, 보안 강화, 프로덕션 팁 | [Lab 12](./11-MCPServerHandsOnLabs/12-Best-Practices/README.md) |
...
|----------|-------------|------|
| C# | MCP 서버 예제 | [View Code](./03-GettingStarted/samples/csharp/README.md) |
| Java | MCP 계산기 | [View Code](./03-GettingStarted/samples/java/calculator/README.md) |
| JavaScript | MCP 데모 | [View Code](./03-GettingStarted/samples/javascript/README.md) |
| Python | MCP 서버 | [View Code](../../03-GettingStarted/samples/python/mcp_calculator_server.py) |
| TypeScript | MCP 예제 | [View Code](./03-GettingStarted/samples/typescript/README.md) |
| Rust | MCP 예제 | [View Code](./03-GettingStarted/samples/rust/README.md) |

#### 고급 MCP 구현체

| Language | Description | Link |
|----------|-------------|------|
| C# | 고급 샘플 | [View Code](./04-PracticalImplementation/samples/csharp/README.md) |
| Java with Spring | 컨테이너 앱 예제 | [View Code](./04-PracticalImplementation/samples/java/containerapp/README.md) |
| JavaScript | 고급 샘플 | [View Code](./04-PracticalImplementation/samples/javascript/README.md) |
| Python | 복잡한 구현 | [View Code](./04-PracticalImplementation/samples/python/README.md) |
| TypeScript | 컨테이너 샘플 | [View Code](./04-PracticalImplementation/samples/typescript/README.md) |
...
이 저장소를 효과적으로 탐색하는 데 도움이 되는 포괄적인 [학습 가이드](./study_guide.md)가 제공됩니다. 이 시각적 커리큘럼 지도는 모든 주제가 어떻게 연결되는지 보여주고 샘플 프로젝트를 효과적으로 사용하는 방법을 안내합니다. 특히 큰 그림을 보고 싶어하는 시각 학습자에게 유용합니다.
...
커리큘럼 자료의 모든 중요한 업데이트를 추적하는 자세한 [변경 로그](./changelog.md)를 유지하여 최신 개선 사항과 추가 사항을 확인할 수 있습니다.  
- 새 콘텐츠 추가  
- 구조 변경  
- 기능 개선  
- 문서 업데이트  
...
코드 샘플을 기여해 주신 Microsoft Valued Professional [Shivam Goyal](https://www.linkedin.com/in/shivam2003/)에게 감사드립니다.

기여 절차는 환영하고 지원적인 방식으로 설계되었습니다. 대부분의 기여는 Contributor License Agreement(CLA)를 요구하지만 자동화 도구가 원활하게 과정을 안내할 것입니다.

## 📜 오픈 소스 학습

이 커리큘럼 전체는 MIT [LICENSE](../../LICENSE) 하에 제공되어 자유롭게 사용, 수정, 공유할 수 있습니다. 이것은 MCP 지식을 전 세계 개발자에게 접근 가능하게 하려는 우리의 사명을 지원합니다.

## 🤝 기여 지침

이 프로젝트는 기여 및 제안을 환영합니다. 대부분의 기여는 귀하가 기여에 대한 권리 보유를 선언하는 Contributor License Agreement(CLA)에 동의해야 합니다. 자세한 내용은 <https://cla.opensource.microsoft.com>을 참조하세요.
...
이 프로젝트는 [Microsoft 오픈 소스 행동 강령](https://opensource.microsoft.com/codeofconduct/)을 채택했습니다. 자세한 내용은 [행동 강령 FAQ](https://opensource.microsoft.com/codeofconduct/faq/)를 참고하거나, 질문 및 의견은 [opencode@microsoft.com](mailto:opencode@microsoft.com)으로 문의하세요.

---

*지금 바로 MCP 여정을 시작하세요! [Module 00 - MCP 소개](./00-Introduction/README.md)부터 시작해 Model Context Protocol 개발 세계에 첫 발을 내딛으세요!*



## 🎒 다른 강좌들

우리 팀은 다른 강좌도 제작합니다! 다음을 확인해 보세요:
...
[![Copilot 모험](https://img.shields.io/badge/Copilot%20Adventure-FDE68A?style=for-the-badge&labelColor=E5E7EB&color=FDE68A)](https://github.com/microsoft/CopilotAdventures?WT.mc_id=academic-105485-koreyst)
...
**면책 조항**:  
이 문서는 AI 번역 서비스 [Co-op Translator](https://github.com/Azure/co-op-translator)를 사용하여 번역되었습니다. 정확성을 위해 노력하고 있으나, 자동 번역에는 오류나 부정확성이 있을 수 있음을 유의하시기 바랍니다. 원본 문서가 권위 있는 자료로 간주되어야 합니다. 중요한 정보의 경우 전문적인 인간 번역을 권장합니다. 본 번역 사용으로 인한 오해나 잘못된 해석에 대해 당사는 책임을 지지 않습니다.
